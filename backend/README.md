...
## Project Structure
    ...
    ├── testregression_dev_27653  # Django project configurations
...
1. Clone this repo and `cd testregression_dev_27653`
...
2. Clone this repo and `cd testregression_dev_27653`
